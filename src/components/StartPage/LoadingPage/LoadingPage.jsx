	...
	return (
		<div className={style.container}>
			...
			<div className={style.description}>
				<h2>Twoje myśli, Twoje notatki, Twój porządek!</h2>
				<p>
					Note it to intuicyjna aplikacja do tworzenia, organizowania i
					zarządzania notatkami. Umożliwia szybkie zapisywanie pomysłów, list
					zadań i ważnych informacji w jednym miejscu. Dzięki przejrzystemu
					interfejsowi i funkcjom synchronizacji masz dostęp do swoich notatek
					zawsze i wszędzie.
				</p>
				<p>Note it - notuj łatwo, myśl swobodnie!</p>
			</div>
